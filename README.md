...
This runs the "query" function, which will return how many available bytes can be generated, with output: `available bytes with combining factor of 1: 580753524`.
